		...
		<div class="navbar">
			<div class="navbar-inner">
				<div class="container-fluid">
					...
					<a class="brand" href="../beranda.php"><span><img alt="logo panti" src="../../assets/image/logo.png" style="width:200px;"/></span></a>
						...
						<div class="row-fluid sortable">
									...
									<div class="box span10">
										<div class="box-header" data-original-title>
											<h2><i class="halflings-icon edit"></i><span class="break"></span>Ubah Profil Admin</h2>
											<div class="box-icon">
											...
											<form class="form-horizontal" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>?id=<?php echo $id;?>">
											  <fieldset>
												<div class="control-group">
												  ...
												  <div class="controls">
													<input type="text" class="span6 typeahead" id="username" name="username" value="<?php echo $username;?>" data-provide="typeahead" data-items="4" readonly>
												  </div>
												...
												<div class="form-actions">
												  ...
												  &nbsp <button type="button" class="btn btn-default" onClick="window.location.href='lihat_admin.php'">Batal</button></td>
												</div>
											  </fieldset>
											</form>   
										</div>
